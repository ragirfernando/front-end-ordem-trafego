                  ...
                  <v-container>
                    <v-row>
                      <v-col cols="12" sm="6" md="4">
                        <v-text-field v-model="condutor.nome" label="Nome"></v-text-field>
                      </v-col>

                      <v-col cols="12" sm="6" md="4">
                        <v-text-field v-model="condutor.cnh.numeroCNH" label="Número cnh"></v-text-field>
                      </v-col>
                      ...
                      <v-col cols="12" sm="6" md="4">
                        ...
                        >
                          ...
                          <v-date-picker v-model="condutor.cnh.validade" no-title scrollable  locale="br" >
                      ...
                      <v-col cols="12" sm="6" md="4">
                        <v-text-field v-model="condutor.endereco.cidade" label="Cidade"></v-text-field>
                      </v-col>

                      <v-col cols="12" sm="6" md="4">
                        <v-text-field v-model="condutor.endereco.bairro" label="Bairro"></v-text-field>
                      </v-col>

                      <v-col cols="12" sm="6" md="4">
                        <v-text-field v-model="condutor.endereco.numero" label="Número"></v-text-field>
                      </v-col>

                      <v-col cols="12" sm="6" md="4">
                        <v-text-field v-model="condutor.endereco.complemento" label="Complemento"></v-text-field>
                      </v-col>

                      <v-col cols="12" sm="6" md="4">
                        <v-text-field v-model="condutor.cpf" label="CPF"></v-text-field>
                      </v-col>

                      <v-col cols="12" sm="6" md="4">
                        <v-text-field v-model="condutor.matricula" label="Matricula"></v-text-field>
                      </v-col>
                    </v-row>
                  </v-container>
                </v-card-text>
...
<script>
import Condutores from "/home/ragir/Sistemas-para-Internet/Novas-Tecnologias/Trafego/front-end-ordem-trafego/src/service/condutor";
...
export default {
  ...
  methods: {
    initialize() {
      Condutores.listar().then(resposta => {
    ...
    save() {
      Condutores.inserirVeiculo(this.condutor).then(resposta => {
    ...
    editItem(item) {
      Condutores.atualizar(item).then(resposta => {
        console.log(resposta);
